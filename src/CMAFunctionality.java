...
public class CMAFunctionality {
    ...
    static class numberList {
        ...
        Integer[] days = IntStream.range(1, 101).boxed().toArray(Integer[]::new);
    ...
    static class AddingProperties {
        ...
        public String addHomesSold(String address, int erf_size, int living_room, int bedroom, int bathroom, int garage, boolean pool, boolean flat, boolean domestic_quar, String other_detail , int days_on_market, double list_price, double sold_price) {
            ...
            return "The property has been added. Add another property or click \"Next\" to go the the next page";
        }
        ...
        public String addHomesExpired(String address, int erf_size, int living_room, int bedroom, int bathroom, int garage, boolean pool, boolean flat, boolean domestic_quar, String other_detail , int days_on_market, double list_price) {
            try (Connection connection = DatabaseConnector.connect()) {
                String sql = "INSERT INTO home_expired (address, erf_size, living_room, bedroom, bathroom, garage, pool, flat, domestic_quar, other_detail , days_on_market, list_price) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
                PreparedStatement ps = connection.prepareStatement(sql);
        ...
        public String addYourProp(String address, int erf_size, int living_room, int bedroom, int bathroom, int garage, boolean pool, boolean flat, boolean domestic_quar, String other_detail , int days_on_market, double list_price) {
            try (Connection connection = DatabaseConnector.connect()) {
                String sql = "INSERT INTO your_property (address, erf_size, living_room, bedroom, bathroom, garage, pool, flat, domestic_quar, other_detail , days_on_market, list_price) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
                PreparedStatement ps = connection.prepareStatement(sql);
